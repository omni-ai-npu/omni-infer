    ...
    def test_compile_with_multiple_config_options(self, default_npugraph_ex_adaptor, mock_inputs, mock_npugraph_ex_module):
        ...
        with patch("torch._inductor.compile_fx.graph_returns_tuple") as mock_graph_returns_tuple:
            with patch("omni_npu.compilation.npugraph_ex_config.get_aclgraph_config") as mock_get_aclgraph_config:
                ...
                assert mock_config_obj.debug.aclgraph.clone_input is False
                assert mock_config_obj.debug.aclgraph.enable_output_clone is True
                assert mock_config_obj.experimental_config.remove_noop_ops is False
                assert mock_config_obj.debug.aclgraph.disable_reinplace_inplaceable_ops_pass is False
                assert mock_config_obj.debug.aclgraph.disable_reinplace_input_mutated_ops_pass is False
                assert mock_config_obj.experimental_config.pattern_fusion_pass is False
