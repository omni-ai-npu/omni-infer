...
@register_patch("ShmBroadcastMessageQueuePatch", shm_broadcast.MessageQueue)
class ShmBroadcastMessageQueuePatch(VLLMPatch):
    _attr_names_to_apply = ["acquire_write"]
