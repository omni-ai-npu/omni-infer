...
# Layer-parallel communication registry.
# Fixed name: _LAYER_COMM_DICT.
# Keys are layer names from layer_parallel_config (e.g. "self_attn.q_proj").
# Each value is a flat dict with three optional fields:
#   - parallel_group: a GroupCoordinator, or None
#   - x_transform: a transform-spec dict, or None
#   - y_transform: a transform-spec dict, or None
# A transform-spec dict carries "type", "dim", and "parallel_group" entries.
