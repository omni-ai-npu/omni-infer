...
#
# Runs inside the prefill container (ldy-92B-prefill).
...
#
# Usage:
#     PREFILL_ENDPOINTS=127.0.0.1:8000 \
#     DECODE_ENDPOINTS=127.0.0.1:8082,127.0.0.1:8083,...  \
...
: "${PROXY_DECODE_MAX_NUM_SEQS:=1024}"
