...
#define MAX_ENCODE_UPSTREAMS 128
...
typedef struct omni_request_metrics_s
{
    ...
    struct timeval time_encode_start;
    struct timeval time_encode_scheduled;
    struct timeval time_encode_end;
...
typedef struct omni_request_s
{
    ...
    bool has_encode_sched;
    bool has_prefill_sched;
    bool has_decode_sched;
    uint16_t encode_upstream_endpoint_idx;
    uint32_t encode_item_count;
...
typedef struct omni_upstream_encode_s
{
    omni_upstream_common_t comm;
    uint32_t num_running;
    uint32_t num_tokens;
...
typedef struct omni_global_state_s
{
    ...
    uint16_t num_encode_endpoints;
    uint16_t last_selected_encode;
    ...
    omni_upstream_encode_t encode_states[MAX_ENCODE_UPSTREAMS];
