...
from omni_placement.utils import filter_dict_keys,convert_param_dict_to_list,convert_param_to_ctype,get_expert_ids
from omni_placement.placement_handler import init_dram_weights,deepseek_filter_func ,deepseek_get_layer_idx_func
...
class TestConvertParamToCtype(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher = patch('omni_placement.utils.omni_placement.Tensor', self.mock_tensor_class)
        self.patcher.start()
