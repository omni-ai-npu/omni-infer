...
def create_placement_manager(rank, world_size, hccl_comm_world_size, num_devices_per_host, cluster_activation=None, expert_mapping=None, enable_dynamic=False, enable_new_context=False):
    """
