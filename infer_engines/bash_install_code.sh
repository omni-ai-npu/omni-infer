...
git apply --whitespace=nowarn $PATCH_ROOT/omni_cache_reuse_rate.patch
...
git apply --whitespace=nowarn $PATCH_ROOT/guard_find_longest_cache_hit_stale_hash_chain.patch
verify_parser_patches
