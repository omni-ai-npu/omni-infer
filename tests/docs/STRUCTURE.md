...
The test directory structure mirrors the source code structure in `omni/` to make it easy to find tests for specific components.
...
│   └── distributed/
│       ├── __init__.py
│       └── test_communicator.py    # Tests for omni/distributed/communicator.py
│
...
### For a new source file: `omni/foo/bar.py`
...
- **Source file**: `omni/distributed/communicator.py`
...
1. **Easy to find tests**: If you're working on `omni/distributed/communicator.py`, you know tests are in `tests/*/distributed/test_communicator.py`
