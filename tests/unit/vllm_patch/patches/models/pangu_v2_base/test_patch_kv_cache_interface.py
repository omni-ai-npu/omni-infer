...
from omni_npu.vllm_patches.patches.models.pangu_v2_base import patch_kv_cache_interface as patch_mod
...
def test_mome_page_size_memory_and_uniformity():
    ...
    config = SimpleNamespace(
        ...
        # vllm 0.25.1: N=12 (num_retained=2, num_tokens=14,
        # cdiv(14, 4)=4, max_blocks=4+1+0=5)
        scheduler_config=SimpleNamespace(max_num_batched_tokens=12),
    )
