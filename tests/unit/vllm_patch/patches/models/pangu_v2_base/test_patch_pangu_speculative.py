...
from omni_npu.vllm_patches.patches.common.patch_eagle import EagleProposerPatch
from omni_npu.vllm_patches.patches.models.pangu_v2_base import patch_speculative as patch_mod
...
def test_prepare_inputs_padded_carries_cpu_metadata_shadows():
    ...
    with patch(
        "omni_npu.vllm_patches.patches.common.patch_eagle.CommonAttentionMetadata",
