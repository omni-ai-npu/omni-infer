...
from omni_npu.vllm_patches.patches.common import patch_block_table
from omni_npu.vllm_patches.patches.models.pangu_v2_base import patch_kv_cache_utils as patch_mod
