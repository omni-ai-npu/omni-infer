...
def test_injects_config_into_vllm_configs():
    ...
    import omni_npu.vllm_patches.patches.models.kimi.patch_kimi_config  # noqa: F401
...
def test_registers_in_config_registry(monkeypatch):
    ...
    import omni_npu.vllm_patches.patches.models.kimi.patch_kimi_config as patch_mod
...
def test_reimport_does_not_raise():
    ...
    import omni_npu.vllm_patches.patches.models.kimi.patch_kimi_config as mod
