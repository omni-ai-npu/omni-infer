...
"""Unit tests for omni.envs (single env-var registry, lazy eval, 3-tier fallback).
...
def test_old_name_fallback_with_deprecation(monkeypatch, caplog):
    ...
    import omni.envs as envs
    with caplog.at_level(logging.WARNING, logger="omni.envs"):
