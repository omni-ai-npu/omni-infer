...
if TYPE_CHECKING:
    ...
    # Existing OMNI_ names without legacy aliases
    OMNI_NPU_VLLM_PATCHES: str
    OMNI_NPU_PATCHES_DIR: str
    OMNI_NPU_PENALTY_CACHE: bool
    OMNI_REUSE_PREFILLED_TOKENS: bool
    OMNI_SKIP_DECODE_TOKENIZE: bool
    OMNI_CONFIG_SUMMARY: bool
    OMNI_NPU_USE_DEVICE_COMM_A2A: bool
    ...
    OMNI_NPU_BENCH_ALIGNED_DECODE_THRESHOLD: int
...
env_variables: Dict[str, Callable[[], Any]] = {
    ...
    # enabled via OMNI_NPU_VLLM_PATCHES (either "ALL" or explicitly listed).
    ...
    # and logs a warning. Only effective when OMNI_NPU_PATCHES_DIR loads
    ...
    # =========================================================================
    # Existing OMNI_-prefixed variables (no legacy aliases)
    # =========================================================================
    ...
    lambda: get_env_with_fallback("OMNI_NPU_VLLM_PATCHES", None, ""),
    ...
    lambda: get_env_with_fallback("OMNI_NPU_PATCHES_DIR", None, ""),
    ...
    lambda: get_env_with_fallback("OMNI_NPU_PENALTY_CACHE", None, False, _as_bool),
    ...
    lambda: get_env_with_fallback("OMNI_NPU_USE_DEVICE_COMM_A2A", None, False, _as_bool),
    ...
    # Requires OMNI_NPU_PATCHES_DIR to include pangu_v2_benchmark. Mutually
    ...
    # Requires OMNI_NPU_PATCHES_DIR to include pangu_v2_benchmark; internal-LB
    ...
    # OMNI_NPU_PATCHES_DIR to include pd_bench_aligned_decode (a separate
    ...
    lambda: get_env_with_fallback(
        ...
        20,
        lambda raw: _as_int_or_default(
            raw, 20, "OMNI_NPU_BENCH_ALIGNED_DECODE_THRESHOLD"),
    ),
}
