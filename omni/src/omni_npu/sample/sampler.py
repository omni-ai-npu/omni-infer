...
class NPUSamplerV1(SamplerV1):
    def __init__(self, logprobs_mode: LogprobsMode = "raw_logprobs"):
        ...
        self.dsa_stream = named_stream("dsa_stream")
        # Spec-decode stash: the rejection sampler pre-generates this step's
        # bonus sampling noise and parks a default-stream copy here.
        self.bonus_q = None
        self.topk_topp_sampler = NPUTopKTopPSampler(logprobs_mode, self)
