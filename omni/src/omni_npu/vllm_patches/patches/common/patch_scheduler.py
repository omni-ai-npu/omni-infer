...
class SchedulerPatch(VLLMPatch):
    ...
    def update_from_output(
        ...
        for req_id, num_tokens_scheduled in num_scheduled_tokens.items():
            ...
            # Patch: Added `and generated_token_ids` check
            ...
            if new_token_ids and self.structured_output_manager.should_advance(request):
                ...
                if struct_output_request is None:
                    raise RuntimeError("struct_output_request is None")
                if struct_output_request.grammar is None:
                    raise RuntimeError("struct_output_request.grammar is None")
