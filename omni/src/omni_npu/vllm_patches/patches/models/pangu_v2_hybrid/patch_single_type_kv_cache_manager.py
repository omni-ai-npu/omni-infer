        ...
        for i in range(max_num_blocks - 1, -1, -1):
            if cached_block := block_pool.get_cached_block(
                ...
                for computed, cached in zip(computed_blocks, cached_block):
                    # The later hit-length computation assumes block-aligned
                    # positions, so insert placeholders before the matched block.
                ...
                if is_full_attn and cached_blocks is not None:
                    ...
                    for group_id in group_ids:
                        ...
                        assert blocks is not None, (
                            f"cache-hit blocks for group {group_id} should be initialized."
                        )
                    ...
                    hit_blocks = manager_cls.find_longest_cache_hit(
                        ...
                        kv_cache_spec=spec,
                        use_eagle=self.use_eagle and is_full_attn,
...
single_type_kv_cache_manager.spec_manager_map.update(
    {
        ...
        ShareKVSlidingWindowSpec: ShareKVSlidingWindowManager,
