...
class MergeDynamicQuantPattern:
    ...
    def register(self):
        def pattern(
            ...
            x_quant_0, x_scale_0 = torch_npu.npu_dynamic_quant(hidden_states, smooth_scales=None)
            ...
            x_quant_1, x_scale_1 = torch_npu.npu_dynamic_quant(hidden_states, smooth_scales=None)
        ...
        def replacement(
            ...
            x_quant, x_scale = torch_npu.npu_dynamic_quant(hidden_states, smooth_scales=None)
            y0 = torch_npu.npu_quant_matmul(
                x1=x_quant,
                x2=weight_0,
                scale=scale_0,
