...
注：在 ansible 中，可以在 prefill 的 EXTRA_ARGS 中添加：
   
- `EXTRA_ARGS = '--scheduler-cls=omni.adaptors.vllm.worker.tfas.tfas_scheduler.TFASProfilerScheduler'`
...
- `EXTRA_ARGS = '--scheduler-cls=omni.adaptors.vllm.worker.tfas.tfas_scheduler.TFASScheduler --additional-config={"tfas_scheduler_config":{"adjust_param":3.6, "token_budget":9154}}'`
