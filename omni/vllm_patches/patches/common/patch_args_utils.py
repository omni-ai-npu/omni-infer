...
class EngineArgsPatch(VLLMPatch):
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        parser.add_argument(
            ...
            type=str,
            default=None,
            help='Config for MM feature transfer, e.g. \'{"connector_type":"DiskMMFeatureConnector",...}\''
        )
        return parser
    ...
    def from_cli_args(cls, args: argparse.Namespace):
        ...
        if args.mm_feature_transfer_config:
            from omni_npu.connector.mm_feature_transfer import register
            register(args.mm_feature_transfer_config)
