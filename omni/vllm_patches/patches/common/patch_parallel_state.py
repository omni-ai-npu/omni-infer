...
class ParallelStatePatch(VLLMPatch):
    ...
    def initialize_model_parallel(
        ...
        _require(
            parallel_state._EP is None,
            "expert parallel group is already initialized",
        )
        _require(
            getattr(parallel_state, "_MOE_DISPATCH_EP", None) is None,
        ...
        if config.model_config is None or config.model_config.is_moe:
            ...
            _require(
                parallel_state._EPLB is None,
                "EPLB group is already initialized",
            )
...
class GroupCoordinatorPatch(VLLMPatch):
    ...
    def __init__(
        ...
        _require(self_cpu_group is not None, "cpu process group was not created")
        _require(self_device_group is not None, "device process group was not created")
